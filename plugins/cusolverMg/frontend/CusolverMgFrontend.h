...
#ifndef CUSOLVERMGFRONTEND_H
#define CUSOLVERMGFRONTEND_H
...
static inline cusolverStatus_t GetExitCode() {
    return (cusolverStatus_t) Frontend::GetFrontend()->GetExitCode();
