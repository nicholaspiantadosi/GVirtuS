...
int main(int argn, char *argv[]) {
    ...
    cusparseZcsrgeam2(handle, m, n, &alpha, descrA, nnzA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &beta, descrB, nnzB, dCsrValB, dCsrRowPtrB, dCsrColIndB,
