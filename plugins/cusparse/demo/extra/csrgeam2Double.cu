...
int main(int argn, char *argv[]) {
    ...
    cusparseDcsrgeam2(handle, m, n, &alpha, descrA, nnzA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &beta, descrB, nnzB, dCsrValB, dCsrRowPtrB, dCsrColIndB,
