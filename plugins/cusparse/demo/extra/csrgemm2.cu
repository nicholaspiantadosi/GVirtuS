...
int main(int argn, char *argv[]) {
    ...
    CHECK_CUDA( cudaMalloc((void**) &dCsrValD, nnzD * sizeof(float)));
    ...
    CHECK_CUDA( cudaMemcpy(dCsrValD, hCsrValD, nnzD * sizeof(float), cudaMemcpyHostToDevice) );
