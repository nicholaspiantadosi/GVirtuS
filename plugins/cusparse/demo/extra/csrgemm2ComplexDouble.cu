...
int main(int argn, char *argv[]) {
    ...
    int nnzB = 8;
    cuDoubleComplex hCsrValB[] = {make_cuDoubleComplex(1, 0), make_cuDoubleComplex(2, 0), make_cuDoubleComplex(3, 0), make_cuDoubleComplex(4, 0), make_cuDoubleComplex(5, 0), make_cuDoubleComplex(6, 0), make_cuDoubleComplex(7, 0), make_cuDoubleComplex(8, 0)};
    int hCsrRowPtrB[] = {0, 3, 4, 6, 8};
    int hCsrColIndB[] = {0, 1, 3, 3, 2, 3, 2, 3};

    int nnzD = 7;
    cuDoubleComplex hCsrValD[] = {make_cuDoubleComplex(1, 0), make_cuDoubleComplex(2, 0), make_cuDoubleComplex(3, 0), make_cuDoubleComplex(4, 0), make_cuDoubleComplex(5, 0), make_cuDoubleComplex(6, 0), make_cuDoubleComplex(7, 0)};
    int hCsrRowPtrD[] = {0, 1, 4, 5, 7};
    int hCsrColIndD[] = {0, 0, 2, 3, 2, 2, 3};

    cuDoubleComplex hCsrValC_result[] = {make_cuDoubleComplex(2, 0), make_cuDoubleComplex(2, 0), make_cuDoubleComplex(31, 0), make_cuDoubleComplex(39, 0), make_cuDoubleComplex(2, 0), make_cuDoubleComplex(3, 0), make_cuDoubleComplex(20, 0), make_cuDoubleComplex(5, 0), make_cuDoubleComplex(10, 0), make_cuDoubleComplex(84, 0), make_cuDoubleComplex(107, 0), make_cuDoubleComplex(69, 0), make_cuDoubleComplex(111, 0)};
    int hCsrRowPtrC_result[] = {0, 4, 7, 11, 13};
    int hCsrColIndC_result[] = {0, 1, 2, 3, 0, 2, 3, 0, 1, 2, 3, 2, 3};

    // Device memory management

    cuDoubleComplex *dCsrValA, *dCsrValB, *dCsrValC, *dCsrValD;
    ...
    CHECK_CUDA( cudaMemcpy(dCsrValB, hCsrValB, nnzB * sizeof(cuDoubleComplex), cudaMemcpyHostToDevice) );
    ...
    CHECK_CUDA( cudaMemcpy(dCsrValD, hCsrValD, nnzD * sizeof(cuDoubleComplex), cudaMemcpyHostToDevice) );
    ...
    cudaMalloc((void**)&dCsrValC, sizeof(cuDoubleComplex)*nnzC);
    ...
    cuDoubleComplex hCsrValC[nnzC];
    int hCsrRowPtrC[m+1];
    int hCsrColIndC[nnzC];

    CHECK_CUDA( cudaMemcpy(hCsrValC, dCsrValC, nnzC * sizeof(cuDoubleComplex), cudaMemcpyDeviceToHost) );
