...
int main(int argn, char *argv[])
{
    ...
    cuComplex hx_result[] = {make_cuComplex(1.000000, 0), make_cuComplex(0.717949, 0), make_cuComplex(0.000000, 0), make_cuComplex(-0.871795, 0),
                             make_cuComplex(0.000000, 0), make_cuComplex(10.128206, 0), make_cuComplex(1.000000, 0), make_cuComplex(-6.128206, 0),
    ...
    cusparseCgtsvInterleavedBatch_bufferSizeExt(handle, algo, m, ddl, dd, ddu, dx, batchCount, &bufferSizeInBytes);

    cudaMalloc((void**)&pBuffer, bufferSizeInBytes);

    cusparseCgtsvInterleavedBatch(handle, algo, m, ddl, dd, ddu, dx, batchCount, pBuffer);
