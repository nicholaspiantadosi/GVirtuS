...
int main(int argn, char *argv[])
{
    ...
    cuDoubleComplex hCsrValA[] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
    int hCsrRowPtrA[] = {0, 3, 4, 7, 9};
    int hCsrColIndA[] = {0, 2, 3, 1, 0, 2, 3, 1, 3};

    cuDoubleComplex hx[] = {1, 2, 3, 4};
    cuDoubleComplex hy[] = {5, 6, 7, 8};
    cuDoubleComplex hz[] = {9, 10, 11, 12};

    cuDoubleComplex hx_result[] = {1, 2, 3, 4};
    cuDoubleComplex hy_result[] = {5, 6, 7, 8};
    cuDoubleComplex hz_result[] = {9, 10, 11, 12};
    */

    const int m = 2;
    const int nnz = 3;

    cuDoubleComplex hCsrValA[] = {make_cuDoubleComplex(1, 0), make_cuDoubleComplex(2, 0), make_cuDoubleComplex(3, 0)};
    int hCsrRowPtrA[] = {0, 2, 3};
    int hCsrColIndA[] = {0, 1, 1};

    cuDoubleComplex hx[] = {make_cuDoubleComplex(1, 0), make_cuDoubleComplex(2, 0)};
    cuDoubleComplex hy[] = {make_cuDoubleComplex(3, 0), make_cuDoubleComplex(4, 0)};
    cuDoubleComplex hz[] = {make_cuDoubleComplex(5, 0), make_cuDoubleComplex(6, 0)};
    ...
    CHECK_CUDA( cudaMemcpy(dz, hz, m * sizeof(cuDoubleComplex), cudaMemcpyHostToDevice) );
    ...
    // device result check
    CHECK_CUDA( cudaMemcpy(hx, dx, m * sizeof(cuDoubleComplex), cudaMemcpyDeviceToHost) );
    CHECK_CUDA( cudaMemcpy(hy, dy, m * sizeof(cuDoubleComplex), cudaMemcpyDeviceToHost) );
    CHECK_CUDA( cudaMemcpy(hz, dz, m * sizeof(cuDoubleComplex), cudaMemcpyDeviceToHost) );
