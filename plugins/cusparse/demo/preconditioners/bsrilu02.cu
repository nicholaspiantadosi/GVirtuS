...
int main(int argn, char *argv[])
{
    ...
    cusparseSbsrilu02_bufferSize(handle, dir, mb, nnzb,
    ...
    cusparseSbsrsv2_bufferSize(handle, dir, trans_U, mb, nnzb,
    ...
    cusparseSbsrilu02_analysis(handle, dir, mb, nnzb, descr_M,
    ...
    cusparseSbsrsv2_analysis(handle, dir, trans_U, mb, nnzb, descr_U,
                             dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize,
                             info_U, policy_U, pBuffer);

    // step 5: M = L * U
    cusparseSbsrilu02(handle, dir, mb, nnzb, descr_M,
    ...
    // step 7: solve U*y = z
    cusparseSbsrsv2_solve(handle, dir, trans_U, mb, nnzb, &alpha, descr_U,
