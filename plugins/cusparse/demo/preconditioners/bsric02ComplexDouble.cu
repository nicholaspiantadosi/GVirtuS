...
int main(int argn, char *argv[])
{
    ...
    cusparseZbsric02_bufferSize(handle, dir, mb, nnzb,
    ...
    cusparseZbsrsv2_bufferSize(handle, dir, trans_Lt, mb, nnzb,
    ...
    cusparseZbsric02_analysis(handle, dir, mb, nnzb, descr_M,
    ...
    cusparseZbsrsv2_analysis(handle, dir, trans_Lt, mb, nnzb, descr_L,
                             dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize,
                             info_Lt, policy_Lt, pBuffer);

    // step 5: M = L * L'
    cusparseZbsric02(handle, dir, mb, nnzb, descr_M,
    ...
    // step 7: solve L'*y = z
    cusparseZbsrsv2_solve(handle, dir, trans_Lt, mb, nnzb, &alpha, descr_L,
