...
int main(int argn, char *argv[])
{
    ...
    cuDoubleComplex *dBsrValA, *dx, *dy, *dz;
    ...
    cusparseZbsrilu02_bufferSize(handle, dir, mb, nnzb,
                                 descr_M, dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize, info_M, &pBufferSize_M);
    cusparseZbsrsv2_bufferSize(handle, dir, trans_L, mb, nnzb,
                               descr_L, dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize, info_L, &pBufferSize_L);
    cusparseZbsrsv2_bufferSize(handle, dir, trans_U, mb, nnzb,
    ...
    cusparseZbsrilu02_analysis(handle, dir, mb, nnzb, descr_M,
    ...
    cusparseZbsrsv2_analysis(handle, dir, trans_L, mb, nnzb, descr_L,
                             dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize,
                             info_L, policy_L, pBuffer);

    cusparseZbsrsv2_analysis(handle, dir, trans_U, mb, nnzb, descr_U,
                             dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize,
                             info_U, policy_U, pBuffer);

    // step 5: M = L * U
    cusparseZbsrilu02(handle, dir, mb, nnzb, descr_M,
    ...
    // step 6: solve L*z = x
    cusparseZbsrsv2_solve(handle, dir, trans_L, mb, nnzb, &alpha, descr_L,
                          dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize, info_L,
                          dx, dz, policy_L, pBuffer);

    // step 7: solve U*y = z
    cusparseZbsrsv2_solve(handle, dir, trans_U, mb, nnzb, &alpha, descr_U,
