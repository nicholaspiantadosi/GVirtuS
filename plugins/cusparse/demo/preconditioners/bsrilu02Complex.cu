...
int main(int argn, char *argv[])
{
    ...
    cuComplex hy_result[] = {make_cuComplex(0, 0), make_cuComplex(0.5, 0), make_cuComplex(0.5, 0), make_cuComplex(0, 0)};
    ...
    cusparseCbsrilu02_bufferSize(handle, dir, mb, nnzb,
    ...
    cusparseCbsrsv2_bufferSize(handle, dir, trans_U, mb, nnzb,
    ...
    cusparseCbsrilu02_analysis(handle, dir, mb, nnzb, descr_M,
    ...
    cusparseCbsrsv2_analysis(handle, dir, trans_U, mb, nnzb, descr_U,
                             dBsrValA, dBsrRowPtrA, dBsrColIndA, blockSize,
                             info_U, policy_U, pBuffer);

    // step 5: M = L * U
    cusparseCbsrilu02(handle, dir, mb, nnzb, descr_M,
    ...
    // step 7: solve U*y = z
    cusparseCbsrsv2_solve(handle, dir, trans_U, mb, nnzb, &alpha, descr_U,
