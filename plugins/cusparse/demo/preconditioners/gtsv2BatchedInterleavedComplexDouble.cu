...
int main(int argn, char *argv[])
{
    ...
    cuDoubleComplex hx_result[] = {make_cuDoubleComplex(1.000000, 0), make_cuDoubleComplex(0.717949, 0), make_cuDoubleComplex(0.000000, 0), make_cuDoubleComplex(-0.871795, 0),
                             make_cuDoubleComplex(0.000000, 0), make_cuDoubleComplex(10.128206, 0), make_cuDoubleComplex(1.000000, 0), make_cuDoubleComplex(-6.128206, 0),
    ...
    cusparseZgtsvInterleavedBatch_bufferSizeExt(handle, algo, m, ddl, dd, ddu, dx, batchCount, &bufferSizeInBytes);

    cudaMalloc((void**)&pBuffer, bufferSizeInBytes);

    cusparseZgtsvInterleavedBatch(handle, algo, m, ddl, dd, ddu, dx, batchCount, pBuffer);
