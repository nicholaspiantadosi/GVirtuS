...
int main(void)
{
    ...
    printf("cusparseSetStream\n");
    CHECK_CUSPARSE(cusparseSetStream(handle, streamIn));
    printf("stream created: %s\n", streamIn);

    printf("cusparseGetStream\n");
    CHECK_CUSPARSE(cusparseGetStream(handle, &streamOut));
    printf("stream retrieved: %s\n", streamOut);
