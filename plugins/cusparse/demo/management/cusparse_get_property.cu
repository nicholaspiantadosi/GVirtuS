...
int main(void)
{
    ...
    CHECK_CUSPARSE(cusparseGetProperty(MAJOR_VERSION, &major_version));
    CHECK_CUSPARSE(cusparseGetProperty(MINOR_VERSION, &minor_version));
    CHECK_CUSPARSE(cusparseGetProperty(PATCH_LEVEL, &patch_level));

    printf("cusparseGetProperty MAJOR_VERSION: %d\n", major_version);
    printf("cusparseGetProperty MINOR_VERSION: %d\n", minor_version);
    printf("cusparseGetProperty PATCH_LEVEL: %d\n", patch_level);
