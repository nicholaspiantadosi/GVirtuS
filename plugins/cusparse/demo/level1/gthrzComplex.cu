...
void gthrz(cusparseHandle_t, int, int, cuComplex *, cuComplex *, int *);
...
void gthrz(cusparseHandle_t handle, int n, int nnz, cuComplex * y, cuComplex * xVal, int * xInd) {
    ...
    CHECK_CUSPARSE(cusparseCgthrz(handle, nnz, y_device, xVal_device, xInd_device, CUSPARSE_INDEX_BASE_ZERO));
