...
int main(int argn, char *argv[])
{
    ...
    cuDoubleComplex hCsrValA[] = {make_cuDoubleComplex(1, 0), make_cuDoubleComplex(1, 0), make_cuDoubleComplex(-1, 0), make_cuDoubleComplex(1, 0), make_cuDoubleComplex(2, 0),
                            make_cuDoubleComplex(-1, 0), make_cuDoubleComplex(5, 0)};
    ...
    cusparseZcsrcolor(handle, m, nnz, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &fractionToColor, &ncolors, dColoring, dReordering, info);
