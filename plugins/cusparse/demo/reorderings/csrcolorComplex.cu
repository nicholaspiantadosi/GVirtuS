...
int main(int argn, char *argv[])
{
    ...
    const int m = 3;
    const int nnz = 7;
    float fractionToColor = 0.8;

    cuComplex hCsrValA[] = {make_cuComplex(1, 0), make_cuComplex(1, 0), make_cuComplex(-1, 0), make_cuComplex(1, 0), make_cuComplex(2, 0),
                            make_cuComplex(-1, 0), make_cuComplex(5, 0)};
    ...
    cusparseCcsrcolor(handle, m, nnz, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &fractionToColor, &ncolors, dColoring, dReordering, info);
