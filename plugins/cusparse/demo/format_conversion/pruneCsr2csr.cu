...
int main(int argn, char *argv[])
{
    ...
    float hCsrValC_result[] = {4, 3, 5, 7, 8, 9, 6};
    ...
    CHECK_CUSPARSE(cusparseSpruneCsr2csr_bufferSizeExt(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &threshold, descrC, NULL, dCsrRowPtrC, NULL, &pBufferSize));
    ...
    CHECK_CUSPARSE(cusparseSpruneCsr2csrNnz(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &threshold, descrC, dCsrRowPtrC, nnzTotalDevHostPtr, pBuffer));
    ...
    CHECK_CUSPARSE(cusparseSpruneCsr2csr(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &threshold, descrC, dCsrValC, dCsrRowPtrC, dCsrColIndC, pBuffer));
