...
int main(int argn, char *argv[])
{
    ...
    float hCscValA[] = {1, 5, 4, 2, 3, 9, 7, 8, 6};
    ...
    CHECK_CUDA( cudaMemcpy(dCscValA, hCscValA, nnz * sizeof(float), cudaMemcpyHostToDevice) );
    ...
    cusparseScsc2dense(handle, m, n, descrA, dCscValA, dCscRowIndA, dCscColPtrA, dA, lda);
