...
int main(int argn, char *argv[])
{
    ...
    CHECK_CUSPARSE(cusparseSpruneDense2csr_bufferSizeExt(handle, m, n, dA, lda, &threshold, descrC, NULL, dCsrRowPtrC, NULL, &pBufferSize));
    ...
    CHECK_CUSPARSE(cusparseSpruneDense2csrNnz(handle, m, n, dA, lda, &threshold, descrC, dCsrRowPtrC, nnzTotalDevHostPtr, pBuffer));
    ...
    CHECK_CUSPARSE(cusparseSpruneDense2csr(handle, m, n, dA, lda, &threshold, descrC, dCsrValC, dCsrRowPtrC, dCsrColIndC, pBuffer));
