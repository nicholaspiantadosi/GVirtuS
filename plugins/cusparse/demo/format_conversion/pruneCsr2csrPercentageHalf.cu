...
int main(int argn, char *argv[])
{
    ...
    __half hCsrValC_result[] = {5, 7, 8, 9, 6};
    ...
    CHECK_CUSPARSE(cusparseHpruneCsr2csrByPercentage_bufferSizeExt(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, percentage, descrC, NULL, dCsrRowPtrC, NULL, info, &pBufferSize));
    ...
    CHECK_CUSPARSE(cusparseHpruneCsr2csrNnzByPercentage(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, percentage, descrC, dCsrRowPtrC, nnzTotalDevHostPtr, info, pBuffer));
    ...
    CHECK_CUSPARSE(cusparseHpruneCsr2csrByPercentage(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, percentage, descrC, dCsrValC, dCsrRowPtrC, dCsrColIndC, info, pBuffer));
