...
int main(int argn, char *argv[])
{
    ...
    CHECK_CUSPARSE(cusparseDpruneDense2csrByPercentage_bufferSizeExt(handle, m, n, dA, lda, percentage, descrC, NULL, dCsrRowPtrC, NULL, info, &pBufferSize));
    ...
    CHECK_CUSPARSE(cusparseDpruneDense2csrNnzByPercentage(handle, m, n, dA, lda, percentage, descrC, dCsrRowPtrC, nnzTotalDevHostPtr, info, pBuffer));
    ...
    CHECK_CUSPARSE(cusparseDpruneDense2csrByPercentage(handle, m, n, dA, lda, percentage, descrC, dCsrValC, dCsrRowPtrC, dCsrColIndC, info, pBuffer));
