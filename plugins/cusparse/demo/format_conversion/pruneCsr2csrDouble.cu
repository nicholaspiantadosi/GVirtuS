...
int main(int argn, char *argv[])
{
    ...
    double hCsrValC_result[] = {4, 3, 5, 7, 8, 9, 6};
    ...
    CHECK_CUSPARSE(cusparseDpruneCsr2csr_bufferSizeExt(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &threshold, descrC, NULL, dCsrRowPtrC, NULL, &pBufferSize));
    ...
    CHECK_CUSPARSE(cusparseDpruneCsr2csrNnz(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &threshold, descrC, dCsrRowPtrC, nnzTotalDevHostPtr, pBuffer));
    ...
    CHECK_CUSPARSE(cusparseDpruneCsr2csr(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, &threshold, descrC, dCsrValC, dCsrRowPtrC, dCsrColIndC, pBuffer));
