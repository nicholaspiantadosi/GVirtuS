...
int main(int argn, char *argv[])
{
    ...
    CHECK_CUSPARSE(cusparseSpruneCsr2csrByPercentage_bufferSizeExt(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, percentage, descrC, NULL, dCsrRowPtrC, NULL, info, &pBufferSize));
    ...
    CHECK_CUSPARSE(cusparseSpruneCsr2csrNnzByPercentage(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, percentage, descrC, dCsrRowPtrC, nnzTotalDevHostPtr, info, pBuffer));
    ...
    CHECK_CUSPARSE(cusparseSpruneCsr2csrByPercentage(handle, m, n, nnzA, descrA, dCsrValA, dCsrRowPtrA, dCsrColIndA, percentage, descrC, dCsrValC, dCsrRowPtrC, dCsrColIndC, info, pBuffer));
