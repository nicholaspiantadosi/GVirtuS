...
int main(void) {
    ...
    int Lwork;
    CUSOLVER_CHECK(cusolverDnZpotri_bufferSize(handle, CUBLAS_FILL_MODE_LOWER, n, dA, lda, &Lwork));
    ...
    CUSOLVER_CHECK(cusolverDnZpotri(handle, CUBLAS_FILL_MODE_LOWER, n, dA, lda, Workspace, Lwork, devInfo));
    int hdevInfo;
