...
int main(void) {
    ...
    int Lwork;
    CUSOLVER_CHECK(cusolverDnDpotri_bufferSize(handle, CUBLAS_FILL_MODE_LOWER, n, dA, lda, &Lwork));
    ...
    CUSOLVER_CHECK(cusolverDnDpotri(handle, CUBLAS_FILL_MODE_LOWER, n, dA, lda, Workspace, Lwork, devInfo));
    int hdevInfo;
