...
int main(void) {
    ...
    cuComplex hA_result[] = {make_cuComplex(1, 0), make_cuComplex(0, 0), make_cuComplex(0, 0), make_cuComplex(0, 0), make_cuComplex(0, 0), make_cuComplex(0, 0), make_cuComplex(0, 0), make_cuComplex(0, 0), make_cuComplex(0, 0)};
    ...
    int Lwork;
    CUSOLVER_CHECK(cusolverDnCpotrf_bufferSize(handle, CUBLAS_FILL_MODE_LOWER, n, dA, lda, &Lwork));
    ...
    CUSOLVER_CHECK(cusolverDnCpotrf(handle, CUBLAS_FILL_MODE_LOWER, n, dA, lda, Workspace, Lwork, devInfo));
    int hdevInfo;
