...
int main(void) {
    ...
    CUSOLVER_CHECK(cusolverDnGeqrf_bufferSize(handle, params, m, n, CUDA_R_32F, dA, lda, CUDA_R_32F, dTAU, CUDA_R_32F, &workspaceInBytes));
    ...
    CUSOLVER_CHECK(cusolverDnGeqrf(handle, params, m, n, CUDA_R_32F, dA, lda, CUDA_R_32F, dTAU, CUDA_R_32F, pBuffer, workspaceInBytes, info));
    int hInfo;
