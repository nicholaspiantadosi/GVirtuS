 ...
 */
    ...
    cusolver_status = cusolverDnSetAdvOptions(params, CUSOLVERDN_GETRF, CUSOLVER_ALG_0);
    assert(CUSOLVER_STATUS_SUCCESS == cusolver_status);
...
// step 3: query working space of syevd
    ...
    cusolver_status = cusolverDnSyevd_bufferSize(
            cusolverH,
            params,
            jobz,
            uplo,
...
// step 4: compute spectrum
    cusolver_status = cusolverDnSyevd(
            cusolverH,
            params,
            jobz,
            uplo,
