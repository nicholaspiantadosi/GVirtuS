...
int main(void) {
    ...
    cuComplex x_result[] = {make_cuComplex(0.011885, 0), make_cuComplex(0.308756, 0), make_cuComplex(-0.045113, 0)};
    ...
    int correct = 1;
    cs = cusolverSpCcsrlsvcholHost(handle, m, nnz, descrA, hCsrValA, hCsrRowPtrA, hCsrColIndA, b, 1, 0, x, &singularity);
