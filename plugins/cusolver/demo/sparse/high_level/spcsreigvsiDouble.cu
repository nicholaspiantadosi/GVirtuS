...
int main(void) {
    ...
    const double x0[] = {1, 1, 1};

    double x_result[] = {0.512307, -0.048724, -0.857419};
    ...
    int correct = 1;
    cs = cusolverSpDcsreigvsiHost(handle, m, nnz, descrA, hCsrValA, hCsrRowPtrA, hCsrColIndA, 1, x0, 50, 1, &mu, x);
