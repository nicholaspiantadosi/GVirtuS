...
int main(void) {
    ...
    const cuDoubleComplex x0[] = {make_cuDoubleComplex(1, 0), make_cuDoubleComplex(1, 0), make_cuDoubleComplex(1, 0)};

    cuDoubleComplex x_result[] = {make_cuDoubleComplex(0.512307, 0), make_cuDoubleComplex(-0.048724, 0), make_cuDoubleComplex(-0.857419, 0)};
    ...
    int correct = 1;
    cs = cusolverSpZcsreigvsiHost(handle, m, nnz, descrA, hCsrValA, hCsrRowPtrA, hCsrColIndA, make_cuDoubleComplex(1, 0), x0, 50, 1, &mu, x);
